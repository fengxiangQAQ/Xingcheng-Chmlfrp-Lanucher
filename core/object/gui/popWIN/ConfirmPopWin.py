...
class ConfirmMain(CTkFrameG):
    def __init__(self,master:ConfirmPopWin,text:str,callbackFun:Callable[[bool],None],confirmText:str,confirm_color,confirm_hover_color,title):
        super().__init__(master=master,AA=False)
        self.callbackFun=callbackFun
        self.master:ConfirmPopWin=master
        ctk.CTkLabel(self,text=title,font=("微软雅黑",20,"bold")).grid(row=0,column=0,padx=15,pady=10,sticky="nw")
